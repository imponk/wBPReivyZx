// Menunggu semua font yang didefinisikan di CSS selesai dimuat
document.fonts.ready.then(() => {
    console.log('Semua font kustom telah siap digunakan.');
...
ctx.font = 'bold 24pt "Proxima Nova Custom"';
    ...
    subjudulInput.addEventListener('input', drawImageWithAspect);
    kreditInput.addEventListener('input', drawImageWithAspect);
    rubrikColor.addEventListener('change', drawImageWithAspect);
    judulColor.addEventListener('change', drawImageWithAspect);
    kreditColor.addEventListener('change', drawImageWithAspect);
    invertJawapos.addEventListener('change', drawImageWithAspect);
    invertMedsos.addEventListener('change', drawImageWithAspect);
    ...
    fadeSelect.addEventListener('change', drawImageWithAspect);
    fadeSlider.addEventListener('input', drawImageWithAspect);
    upperUseBlock.addEventListener('change', drawImageWithAspect);
